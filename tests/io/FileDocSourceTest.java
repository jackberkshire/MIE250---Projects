...
public class FileDocSourceTest {
     ...
     * checks to see if the method gets the correct doc info
     */
    @Test
    public void testGetDoc() {
        System.out.println("getDoc");
        int id = 0;
        FileDocSource instance = new FileDocSource("C://Users//Jack//Documents//testing");
        String expResult = "hi the big bear ran ove the sly fox";      
     ...
     * checks to see if the method counts the right amount of docs in the docsource
     */
    @Test
