...
public class TestSCP {
	...
	public static void main(String[] args) throws IOException {
		...
		model.addSetToCover(1, 3.0, Arrays.asList(new Integer[] {1,3,5,7,9}));
                model.addSetToCover(7, 2.0, Arrays.asList(new Integer[] {3,5,7,9}));
                model.addSetToCover(8, 3.0, Arrays.asList(new Integer[] {1,6,5,4,9}));
                model.addSetToCover(9, 3.0, Arrays.asList(new Integer[] {10,4,5,7,9}));

                //model.addSetToCover(1, 1.0, Arrays.asList(new Integer[] {0}));
